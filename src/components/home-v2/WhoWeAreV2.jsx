...
const CARDS = [
  { icon: Headphones, tone: 'blue', title: '24/7 Support', text: 'Always available when you need us.' },
  { icon: Users, tone: 'green', title: 'Expert Team', text: 'Specialists in GHL & automation.' },
  { icon: TrendingUp, tone: 'amber', title: 'Client Growth', text: 'We train, support & help you scale.' },
]
